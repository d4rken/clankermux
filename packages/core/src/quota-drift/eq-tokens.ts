...
> = {
	...
	// GPT-6 Astra lists $10 in / $50 out, GPT-6 Sol $2 / $10, GPT-6 Luna
	// $0.10 / $0.50 and GPT-5.6 Sol $4 / $20: a 5x output ratio against the 6x
	// the rest of the tier carries. Cache read (0.1x) and cache write (1.25x)
	// match on all four.
