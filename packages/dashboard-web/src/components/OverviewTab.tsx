...
export const OverviewTab = React.memo(() => {
	...
	const accountsStaleNote =
		accountsAvailability.state === "stale"
			...
			: undefined;
	// Live forecast details; the shared summary also retains historical model membership.
	...
	return (
		<div className="space-y-section">
			...
			{/* Per-model weekly caps, full width beneath the class cards. A family
			    ...
			    Current readings use the same accounts as the provider cards; history retains model membership. */}
			<FamilyWeeklyCard
				rows={familyRows}
