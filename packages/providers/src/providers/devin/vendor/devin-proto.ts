 ...
 */
import { type MessageCodec, type ProtoMessage, pb } from "./protobuf";
...
export const AllowedModelConfigSchema: MessageCodec<AllowedModelConfig> =
	pb<AllowedModelConfig>("exa.codeium_common_pb.AllowedModelConfig", [
		{
			no: 1,
			name: "modelOrAlias",
			kind: "message",
			T: () => ModelOrAliasSchema,
		},
...
export const AnthropicInferenceConfigSchema: MessageCodec<AnthropicInferenceConfig> =
	pb<AnthropicInferenceConfig>(
		"exa.codeium_common_pb.AnthropicInferenceConfig",
		[
...
export const ArenaConfigSchema: MessageCodec<ArenaConfig> = pb<ArenaConfig>(
	"exa.codeium_common_pb.ArenaConfig",
...
export const AssignModelRequestSchema: MessageCodec<AssignModelRequest> =
	pb<AssignModelRequest>("exa.api_server_pb.AssignModelRequest", [
		{ no: 1, name: "metadata", kind: "message", T: () => MetadataSchema },
		{ no: 2, name: "modelRouterUid", kind: "string" },
		{ no: 3, name: "cascadeId", kind: "string" },
		{
			no: 5,
			name: "chatMessagePrompt",
			kind: "message",
...
export const AssignModelResponseSchema: MessageCodec<AssignModelResponse> =
	pb<AssignModelResponse>("exa.api_server_pb.AssignModelResponse", [
		{
			no: 1,
			name: "assignment",
			kind: "message",
			T: () => ModelAssignmentSchema,
		},
	]);
...
export const CascadeModelConfigDataSchema: MessageCodec<CascadeModelConfigData> =
	pb<CascadeModelConfigData>("exa.codeium_common_pb.CascadeModelConfigData", [
		{
			no: 1,
		...
		{
			no: 2,
			name: "clientModelSorts",
			kind: "message",
			T: () => ClientModelSortSchema,
			repeat: true,
		},
		{
			no: 3,
			name: "defaultOverrideModelConfig",
			kind: "message",
			T: () => DefaultOverrideModelConfigSchema,
		},
...
export const ChatMessagePromptSchema: MessageCodec<ChatMessagePrompt> =
	pb<ChatMessagePrompt>("exa.chat_pb.ChatMessagePrompt", [
		...
		{
			no: 14,
			name: "promptAnnotationRanges",
			kind: "message",
			T: () => PromptAnnotationRangeSchema,
			repeat: true,
		},
...
export const ChatToolChoiceSchema: MessageCodec<ChatToolChoice> =
	pb<ChatToolChoice>("exa.chat_pb.ChatToolChoice", [
		{
			kind: "oneof",
			name: "choice",
			variants: [
...
export const ChatToolDefinitionSchema: MessageCodec<ChatToolDefinition> =
	pb<ChatToolDefinition>("exa.chat_pb.ChatToolDefinition", [
		...
		{
			no: 8,
			name: "computerUseConfig",
			kind: "message",
			T: () => ComputerUseToolConfigSchema,
		},
...
export const ClientModelConfigSchema: MessageCodec<ClientModelConfig> =
	pb<ClientModelConfig>("exa.codeium_common_pb.ClientModelConfig", [
		...
		{
			no: 30,
			name: "modelFamilyMetadata",
			kind: "message",
			T: () => ModelFamilyMetadataSchema,
		},
...
export const ClientModelGroupSchema: MessageCodec<ClientModelGroup> =
	pb<ClientModelGroup>("exa.codeium_common_pb.ClientModelGroup", [
...
export const ClientModelSortSchema: MessageCodec<ClientModelSort> =
	pb<ClientModelSort>("exa.codeium_common_pb.ClientModelSort", [
		{ no: 1, name: "name", kind: "string" },
		{
			no: 2,
			name: "groups",
			kind: "message",
			T: () => ClientModelGroupSchema,
			repeat: true,
		},
...
export const CompletionProfileSchema: MessageCodec<CompletionProfile> =
	pb<CompletionProfile>("exa.codeium_common_pb.CompletionProfile", [
		{
			no: 1,
			name: "modelProfile",
			kind: "message",
			T: () => SingleModelCompletionProfileSchema,
		},
		{
			no: 2,
			name: "draftModelProfile",
			kind: "message",
			T: () => SingleModelCompletionProfileSchema,
		},
...
export const ComputerUseToolConfigSchema: MessageCodec<ComputerUseToolConfig> =
	pb<ComputerUseToolConfig>("exa.chat_pb.ComputerUseToolConfig", [
...
export const CortexTrajectoryReferenceSchema: MessageCodec<CortexTrajectoryReference> =
	pb<CortexTrajectoryReference>("exa.cortex_pb.CortexTrajectoryReference", [
...
export const DefaultOverrideModelConfigSchema: MessageCodec<DefaultOverrideModelConfig> =
	pb<DefaultOverrideModelConfig>(
		"exa.codeium_common_pb.DefaultOverrideModelConfig",
		[
			{
				no: 1,
				name: "modelOrAliasDeprecated",
				kind: "message",
				T: () => ModelOrAliasSchema,
			},
...
export const DevinPlanInfoSchema: MessageCodec<DevinPlanInfo> =
	pb<DevinPlanInfo>("exa.codeium_common_pb.DevinPlanInfo", [
...
export const ExperimentConfigSchema: MessageCodec<ExperimentConfig> =
	pb<ExperimentConfig>("exa.codeium_common_pb.ExperimentConfig", [
		{
			no: 6,
			name: "experiments",
			kind: "message",
			T: () => ExperimentWithVariantSchema,
			repeat: true,
		},
		...
		{
			no: 3,
			name: "forceEnableExperimentsWithVariants",
			kind: "message",
			T: () => ExperimentWithVariantSchema,
			repeat: true,
		},
		{
			no: 4,
			name: "forceEnableExperimentStrings",
			kind: "string",
			repeat: true,
		},
		{
			no: 5,
			name: "forceDisableExperimentStrings",
			kind: "string",
			repeat: true,
		},
...
export const ExperimentWithVariantSchema: MessageCodec<ExperimentWithVariant> =
	pb<ExperimentWithVariant>("exa.codeium_common_pb.ExperimentWithVariant", [
...
export const FastStatusSchema: MessageCodec<FastStatus> = pb<FastStatus>(
	"exa.codeium_common_pb.FastStatus",
	[
...
export const GetChatMessageRequestSchema: MessageCodec<GetChatMessageRequest> =
	pb<GetChatMessageRequest>("exa.api_server_pb.GetChatMessageRequest", [
		...
		{ no: 7, name: "requestType", kind: "enum" },
		{
			...
			name: "configuration",
			kind: "message",
			T: () => CompletionConfigurationSchema,
		},
		{
			no: 9,
			name: "experimentConfig",
			kind: "message",
			T: () => ExperimentConfigSchema,
		},
		{
			no: 10,
			name: "tools",
			kind: "message",
			T: () => ChatToolDefinitionSchema,
			repeat: true,
		},
		...
		{ no: 14, name: "chatModelName", kind: "string" },
		{
			...
			kind: "message",
			T: () => CortexTrajectoryReferenceSchema,
		},
...
export const GetChatMessageResponseSchema: MessageCodec<GetChatMessageResponse> =
	pb<GetChatMessageResponse>("exa.api_server_pb.GetChatMessageResponse", [
		...
		{
			no: 26,
			name: "committedQuotaCostBasisPoints",
			kind: "int64",
			optional: true,
		},
		{
			no: 27,
			name: "committedOverageCostCents",
			kind: "int64",
			optional: true,
		},
		{
			no: 28,
			name: "responseDimensionGroups",
			kind: "message",
			T: () => ResponseDimensionGroupSchema,
			repeat: true,
		},
	]);
...
export const GetUserJwtRequestSchema: MessageCodec<GetUserJwtRequest> =
	pb<GetUserJwtRequest>("exa.auth_pb.GetUserJwtRequest", [
		{ no: 1, name: "metadata", kind: "message", T: () => MetadataSchema },
	]);
...
export const GetUserJwtResponseSchema: MessageCodec<GetUserJwtResponse> =
	pb<GetUserJwtResponse>("exa.auth_pb.GetUserJwtResponse", [
...
export const GoogleInferenceConfigSchema: MessageCodec<GoogleInferenceConfig> =
	pb<GoogleInferenceConfig>("exa.codeium_common_pb.GoogleInferenceConfig", [
...
export const InferenceConfigSchema: MessageCodec<InferenceConfig> =
	pb<InferenceConfig>("exa.codeium_common_pb.InferenceConfig", [
		{
			kind: "oneof",
			name: "config",
			variants: [
				{
					...
					name: "openai",
					kind: "message",
					T: () => OpenAIInferenceConfigSchema,
				},
				{
					no: 2,
					name: "google",
					kind: "message",
					T: () => GoogleInferenceConfigSchema,
				},
				{
					no: 3,
					name: "anthropic",
					kind: "message",
					T: () => AnthropicInferenceConfigSchema,
				},
			],
		},
	]);
...
export const McpLocalServerSchema: MessageCodec<McpLocalServer> =
	pb<McpLocalServer>("exa.codeium_common_pb.McpLocalServer", [
...
export const McpRemoteServerSchema: MessageCodec<McpRemoteServer> =
	pb<McpRemoteServer>("exa.codeium_common_pb.McpRemoteServer", [
...
export const McpServerConfigSchema: MessageCodec<McpServerConfig> =
	pb<McpServerConfig>("exa.codeium_common_pb.McpServerConfig", [
			...
			variants: [
				{
					...
					name: "local",
					kind: "message",
					T: () => McpLocalServerSchema,
				},
				{
					no: 3,
					name: "remote",
					kind: "message",
					T: () => McpRemoteServerSchema,
				},
			],
		},
	]);
...
export const ModelAssignmentSchema: MessageCodec<ModelAssignment> =
	pb<ModelAssignment>("exa.api_server_pb.ModelAssignment", [
...
export const ModelDimensionSchema: MessageCodec<ModelDimension> =
	pb<ModelDimension>("exa.codeium_common_pb.ModelDimension", [
		{ no: 1, name: "label", kind: "string" },
...
export const ModelDisabledReasonSchema: MessageCodec<ModelDisabledReason> =
	pb<ModelDisabledReason>("exa.codeium_common_pb.ModelDisabledReason", [
...
export const ModelFamilyMetadataSchema: MessageCodec<ModelFamilyMetadata> =
	pb<ModelFamilyMetadata>("exa.codeium_common_pb.ModelFamilyMetadata", [
		{ no: 1, name: "modelFamilyLabel", kind: "string" },
		{
			no: 2,
			name: "entries",
			kind: "message",
			T: () => ModelFamilyMetadataEntrySchema,
			repeat: true,
		},
...
export const ModelFamilyMetadataEntrySchema: MessageCodec<ModelFamilyMetadataEntry> =
	pb<ModelFamilyMetadataEntry>(
		...
		[
			{ no: 1, name: "key", kind: "string" },
			{
				...
				name: "value",
				kind: "message",
				T: () => ModelFamilyMetadataValueSchema,
			},
		],
	);
...
export const ModelFamilyMetadataValueSchema: MessageCodec<ModelFamilyMetadataValue> =
	pb<ModelFamilyMetadataValue>(
...
export const ModelFeaturesSchema: MessageCodec<ModelFeatures> =
	pb<ModelFeatures>("exa.codeium_common_pb.ModelFeatures", [
...
export const ModelOrAliasSchema: MessageCodec<ModelOrAlias> = pb<ModelOrAlias>(
...
export const ModelUsageStatsSchema: MessageCodec<ModelUsageStats> =
	pb<ModelUsageStats>("exa.codeium_common_pb.ModelUsageStats", [
...
export const OpenAIInferenceConfigSchema: MessageCodec<OpenAIInferenceConfig> =
	pb<OpenAIInferenceConfig>("exa.codeium_common_pb.OpenAIInferenceConfig", [
		{ no: 1, name: "reasoningEffort", kind: "string" },
...
export const PlanInfoSchema: MessageCodec<PlanInfo> = pb<PlanInfo>(
	...
	[
		...
		{
			no: 21,
			name: "cascadeAllowedModelsConfig",
			kind: "message",
			T: () => AllowedModelConfigSchema,
			repeat: true,
		},
		{
			no: 24,
			name: "defaultTeamConfig",
			kind: "message",
			T: () => TeamConfigSchema,
		},
		...
		{
			no: 30,
			name: "defaultTeamFeatures",
			kind: "map",
			K: "string",
			V: () => TeamsFeaturesMetadataSchema,
		},
...
export const PromoStatusSchema: MessageCodec<PromoStatus> = pb<PromoStatus>(
	"exa.codeium_common_pb.PromoStatus",
	[
		{ no: 1, name: "isActive", kind: "bool" },
...
export const PromptAnnotationRangeSchema: MessageCodec<PromptAnnotationRange> =
	pb<PromptAnnotationRange>("exa.codeium_common_pb.PromptAnnotationRange", [
...
export const PromptCacheOptionsSchema: MessageCodec<PromptCacheOptions> =
	pb<PromptCacheOptions>("exa.chat_pb.PromptCacheOptions", [
...
export const ResponseDimensionSchema: MessageCodec<ResponseDimension> =
	pb<ResponseDimension>("exa.codeium_common_pb.ResponseDimension", [
			...
			variants: [
				{
					...
					name: "copyableCode",
					kind: "message",
					T: () => ResponseDimensionCopyableCodeSchema,
				},
				{
					no: 3,
					name: "metric",
					kind: "message",
					T: () => ResponseDimensionMetricSchema,
				},
				{
					no: 4,
					name: "cumulativeMetric",
					kind: "message",
					T: () => ResponseDimensionCumulativeMetricSchema,
				},
			],
		},
	]);
...
export const ResponseDimensionCopyableCodeSchema: MessageCodec<ResponseDimensionCopyableCode> =
	pb<ResponseDimensionCopyableCode>(
...
export const ResponseDimensionCumulativeMetricSchema: MessageCodec<ResponseDimensionCumulativeMetric> =
	pb<ResponseDimensionCumulativeMetric>(
...
export const ResponseDimensionGroupSchema: MessageCodec<ResponseDimensionGroup> =
	pb<ResponseDimensionGroup>("exa.codeium_common_pb.ResponseDimensionGroup", [
		{ no: 1, name: "title", kind: "string" },
		{
			no: 2,
			name: "dimensions",
			kind: "message",
			T: () => ResponseDimensionSchema,
			repeat: true,
		},
	]);
...
export const ResponseDimensionMetricSchema: MessageCodec<ResponseDimensionMetric> =
	pb<ResponseDimensionMetric>("exa.codeium_common_pb.ResponseDimensionMetric", [
		{ no: 1, name: "label", kind: "string" },
		{ no: 2, name: "value", kind: "string" },
	]);
...
export const SingleModelCompletionProfileSchema: MessageCodec<SingleModelCompletionProfile> =
	pb<SingleModelCompletionProfile>(
		"exa.codeium_common_pb.SingleModelCompletionProfile",
		[
...
export const TeamConfigSchema: MessageCodec<TeamConfig> = pb<TeamConfig>(
	"exa.codeium_common_pb.TeamConfig",
	[
		...
		{
			no: 21,
			name: "pullRequestReviewRateLimit",
			kind: "int32",
			optional: true,
		},
...
export const TeamsFeaturesMetadataSchema: MessageCodec<TeamsFeaturesMetadata> =
	pb<TeamsFeaturesMetadata>("exa.codeium_common_pb.TeamsFeaturesMetadata", [
		{ no: 1, name: "isActive", kind: "bool" },
...
export const TimestampSchema: MessageCodec<Timestamp> = pb<Timestamp>(
...
export const TopUpStatusSchema: MessageCodec<TopUpStatus> = pb<TopUpStatus>(
	"exa.codeium_common_pb.TopUpStatus",
	[
...
export const UserStatusSchema: MessageCodec<UserStatus> = pb<UserStatus>(
	...
	[
		...
		{
			no: 33,
			name: "cascadeModelConfigData",
			kind: "message",
			T: () => CascadeModelConfigDataSchema,
		},
		{
			no: 34,
			name: "windsurfProTrialEndTime",
			kind: "message",
			T: () => TimestampSchema,
		},
