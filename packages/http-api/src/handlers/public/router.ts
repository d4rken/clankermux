...
import { createPublicWeeklyReader } from "../../services/public-workloads";
...
import { createPublicWorkloadsHandler } from "./workloads";
...
export class PublicRouter {
	...
	constructor({ dbOps, config, getStrategy }: PublicRouterDeps) {
		...
		const workloadsHandler = createPublicWorkloadsHandler(
			readSnapshot,
			createPublicWeeklyReader(dbOps),
		);
		...
		>([
			...
			["/public/v1/workloads", () => workloadsHandler()],
